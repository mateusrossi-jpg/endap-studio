    ...
    <main className="app-shell">
      <aside className={`sidebar ${isMobileMenuOpen ? 'is-open' : ''}`} aria-label="Navegação principal">
        <div className="brand-card">
          ...
          <button className="mobile-close-btn" onClick={() => setIsMobileMenuOpen(false)} aria-label="Fechar menu principal">✕</button>
        </div>
      ...
      <section className="workspace">
        <header className="topbar">
          <div className="topbar-left">
            <button className="mobile-menu-btn" onClick={() => setIsMobileMenuOpen(true)} aria-label="Abrir menu principal" aria-expanded={isMobileMenuOpen}>
